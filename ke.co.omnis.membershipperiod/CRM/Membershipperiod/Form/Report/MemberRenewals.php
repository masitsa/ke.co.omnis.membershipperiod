 ...
 *
 */
class CRM_Membershipperiod_Form_Report_MemberRenewals extends CRM_Report_Form {
  ...
  protected $_startDate = FALSE;

  protected $_endDate = FALSE;
  ...
  public function __construct() {
    ...
    $this->_columns = array(
      ...
      'civicrm_omnupdatemembershipperiod' => array(
        'dao' => 'CRM_Member_DAO_Membership',
        'fields' => array(
          'start_date' => array(
          ...
          'end_date' => array(
            'title' => ts('Renewal End Date'),
            'default' => TRUE,
          ),
        ),
        'filters' => array(
          'start_date' => array('operatorType' => CRM_Report_Form::OP_DATE),
          'end_date' => array('operatorType' => CRM_Report_Form::OP_DATE),
        ),
        'order_bys' => array(
          'start_date' => array(
            'title' => ts('Start Date'),
  ...
  public function preProcess() {
    $this->assign('reportTitle', ts('Membership Renewals Report'));
    parent::preProcess();
  }
      ...
      if (array_key_exists('fields', $table)) {
        foreach ($table['fields'] as $fieldName => $field) {
          if (!empty($field['required']) || !empty($this->_params['fields'][$fieldName])) {
            ...
            elseif ($tableName == 'civicrm_omnupdatemembershipperiod') {
              $this->_startDate = TRUE;
              $this->_endDate = TRUE;
            }
  ...
  public function from() {
    ...
    //used when renewal field is selected
    if ($this->_startDate) {
      $this->_from .= "
             LEFT JOIN civicrm_omnupdatemembershipperiod cmp
                 ON {$this->_aliases['civicrm_membership']}.id = cmp.membership_id\n";
    }
  }
